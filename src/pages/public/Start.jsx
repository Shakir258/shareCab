...
function Start() {
    return (
        <div>
            ...
            {/* <div className='bg-cover bg-[url(https://plus.unsplash.com/premium_photo-1717013781636-a9207818c98a?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDF8fHxlbnwwfHx8fHw%3D)] h-screen pt-7 w-full flex flex-col justify-between'></div> */}
